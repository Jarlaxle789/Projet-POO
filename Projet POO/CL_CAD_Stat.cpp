#include "CL_CAD_Stat.h"

NS_Composants::CL_CAD_Stat::CL_CAD_Stat(void)
{
...
int NS_Composants::CL_CAD_Stat::actionRowsID(String^ rq_sql)
{
    int id;
    this->setSQL(rq_sql);
...
void NS_Composants::CL_CAD_Stat::actionRows(String^)
{
    //throw gcnew System::NotImplementedException();
    this->setSQL(rq_sql);
    this->CMD->CommandText = this->rq_sql;
...
DataSet^ NS_Composants::CL_CAD_Stat::getRows(String^ rq_sql, String^ dataTableName)
{
    //throw gcnew System::NotImplementedException();
...
void NS_Composants::CL_CAD_Stat::setSQL(String^)
{
